<script lang="js">
	...
	export let content = {
		...
		disclosure:
			'Pay in 4 is available to consumers upon approval for purchases of $50-$500. Pay in 4 is not currently available to residents of Missouri, Nevada, New Mexico, North Dakota, Wisconsin, or any U.S. Territories. Offer availability depends on the merchant and also may not be available for certain recurring, subscription services.​ When applying, a soft credit check may be needed, but will not affect your credit score.​ You must be of legal age in your U.S. state of residence to use Pay in 4.​ Loans to California residents are made or arranged pursuant to a California Financing Law License.​ PayPal, Inc. is a Georgia Installment Lender Licensee, NMLS #910457.​ Rhode Island Small Loan Lender Licensee.',

<script lang="js">
	...
	export let content = {
		estimatedInstallments: {
			...
			items2: [
				{
					principal: { value: '100.00', currency_code: 'USD' },
					payment_type: 'DOWN_PAYMENT',
					remaining_total_amount: { value: '300.00', currency_code: 'USD' },
					payment_number: 1,
					interest: { value: '0.00', currency_code: 'USD' },
					payment_date: '2022-07-11',
					total_payment: { value: '100.00', currency_code: 'USD' }
				},
				{
					principal: { value: '100.00', currency_code: 'USD' },
					payment_type: 'INSTALLMENT',
					remaining_total_amount: { value: '200.00', currency_code: 'USD' },
					payment_number: 2,
					interest: { value: '0.00', currency_code: 'USD' },
				...
				},
				{
					principal: { value: '100.00', currency_code: 'USD' },
					payment_type: 'INSTALLMENT',
					remaining_total_amount: { value: '100.00', currency_code: 'USD' },
					payment_number: 3,
					interest: { value: '0.00', currency_code: 'USD' },
				...
				},
				{
					principal: { value: '100.00', currency_code: 'USD' },
					payment_type: 'INSTALLMENT',
					remaining_total_amount: { value: '0.00', currency_code: 'USD' },
					payment_number: 4,
					interest: { value: '0.00', currency_code: 'USD' },
		...
		disclosure:
			'Pay in 4 is available to consumers upon approval for purchases of {formattedMinAmount}-{formattedMaxAmount}. Pay in 4 is not currently available to residents of Missouri, Nevada, New Mexico, North Dakota, Wisconsin, or any U.S. Territories. Offer availability depends on the merchant and also may not be available for certain recurring, subscription services.​ When applying, a soft credit check may be needed, but will not affect your credit score.​ You must be of legal age in your U.S. state of residence to use Pay in 4.​ Loans to California residents are made or arranged pursuant to a California Financing Law License.​ PayPal, Inc. is a Georgia Installment Lender Licensee, NMLS #910457.​ Rhode Island Small Loan Lender Licensee.',

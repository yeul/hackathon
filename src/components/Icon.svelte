...
{#if typeof content !== 'undefined'}
	<div aria-hidden="true" class="icon__wrapper">{@html content}</div>
{/if}

{#if name === 'logo'}
	<!-- <img aria-hidden="true" alt="PayPal Logo" src={logos.PRIMARY.WHITE[0].src} />; -->
{:else if name === 'close'}
	<svg
		aria-hidden="true"
		width="36"
...
{:else if name === 'header-background'}
	<svg
		aria-hidden="true"
		width="1920"
		height="1380"
